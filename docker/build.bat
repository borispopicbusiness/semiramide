...
docker image build -t operations-portal-backend:%1 .
cd..
cd "gateway"
docker image build -t operations-portal-gateway:%1 .
cd..
cd..
cd..
cd "operations-portal-fe"
docker image build -t operations-portal-frontend:%1 .