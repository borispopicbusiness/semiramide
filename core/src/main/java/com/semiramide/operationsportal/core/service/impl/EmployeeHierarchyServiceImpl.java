package com.semiramide.operationsportal.core.service.impl;
...
import com.semiramide.operationsportal.core.event.event.SubordinateUnassignedEvent;
...
public class EmployeeHierarchyServiceImpl implements EmployeeHierarchyService {
  ...
  public synchronized void loadGraph() {
    // TODO: Ask Drazen for best approach - Should we stop application if the employees are not
    // found?
